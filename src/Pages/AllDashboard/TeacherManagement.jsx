...
function TeacherManagement() {
  ...
  const handleRemoveAssignment = async (teacher) => {
    if (!window.confirm(`Remove assignment for "${teacher.email || teacher.id}"?`)) return
                        ...
                        <td className="px-3 py-2.5">
                          <div className="flex flex-wrap items-center justify-center gap-2">
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-1 rounded-lg bg-[#0f172a] px-3 py-1.5 text-sm font-semibold text-[#ffffff] hover:bg-[#1e293b] disabled:cursor-not-allowed disabled:opacity-50"
                            >
                              <span className={`material-symbols-outlined text-sm ${isAssigning ? 'animate-spin' : ''}`}>
                            ...
                            {teacher.assignedClass || teacher.assignedSection ? (
                              <button
                                ...
                                disabled={isAssigning}
                                className="inline-flex items-center justify-center gap-1 rounded-lg border border-amber-200 px-3 py-1.5 text-sm font-semibold text-amber-700 hover:bg-amber-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-amber-800 dark:text-amber-300 dark:hover:bg-amber-900/20"
                              >
                                Clear
                              </button>
                            ) : null}
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-1 rounded-lg border border-red-200 px-3 py-1.5 text-sm text-red-600 hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/20"
                            >
